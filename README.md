...
AtributoTipoDescriçãonomeStringNome completocpfStringCPF no formato 000.000.000-00idadeintIdade em anos (validada: deve ser > 0)
...
AtributoTipoDescriçãomatriculaStringCódigo de matrículacursoStringNome do cursonotasArrayList<Double>Lista de notas do aluno
...
AtributoTipoDescriçãoespecialidadeStringÁrea de especializaçãosalariodoubleSalário atual
...
AtributoTipoDescriçãosetorStringSetor de atuaçãosalariodoubleSalário basehorasExtrasintQuantidade de horas extras no mês
...
javapublic class Aluno extends Pessoa {
...
javaArrayList<Pessoa> pessoas = new ArrayList<>();
